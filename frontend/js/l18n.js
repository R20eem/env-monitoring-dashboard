...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    ...
    /* ── RESEARCHER — OVERVIEW TAB ── */
    'r.ov_title':           { en: 'Research Overview',                          af: 'Navorsings Oorsig' },
    'r.ov_sub':             { en: 'Summary statistics and alert status across all monitored sites', af: 'Opsommingstake en waarskuwingstatus oor alle gemonitorde persele' },
    'r.stat_total':         { en: 'Total Readings',     af: 'Totale Lesings' },
    'r.stat_total_sub':     { en: 'across all sites',   af: 'oor alle persele' },
    'r.stat_critical':      { en: 'Critical Alerts',    af: 'Kritiese Waarskuwings' },
    'r.stat_warning':       { en: 'Warning Events',     af: 'Waarskuwingsgebeurtenisse' },
    'r.stat_pest':          { en: 'Avg Pest Count',     af: 'Gem. Plaagtelling' },
    'r.stat_pest_sub':      { en: 'traps per reading',  af: 'valle per lesing' },
    'r.alert_dist_title':   { en: 'Alert Type Distribution',                    af: 'Waarskuwingstipe Verspreiding' },
    'r.alert_dist_sub':     { en: 'Breakdown by alert category across all readings', af: 'Uiteensetting per waarskuwingskategorie oor alle lesings' },
    'r.site_status_title':  { en: 'Latest Site Status',                         af: 'Jongste Perseel Status' },
    'r.site_status_sub':    { en: 'Most recent reading per site',               af: 'Mees onlangse lesing per perseel' },
    'r.loading':            { en: 'Loading...',          af: 'Laai...' },
    'r.computing':          { en: 'Computing...',        af: 'Bereken...' },
    'r.pest_ov_title':      { en: 'Pest Population — 30 Day Overview',          af: 'Plaagpopulasie — 30 Dag Oorsig' },
    'r.pest_ov_sub':        { en: 'Average daily pest trap count, all sites',   af: 'Gemiddelde daaglikse plaagvaltelling, alle persele' },
    'r.all_sites':          { en: 'All Sites',           af: 'Alle Persele' },

    /* ── RESEARCHER — TREND ANALYSIS TAB ── */
    'r.tr_title':           { en: 'Trend Analysis',     af: 'Neiging Analise' },
    'r.tr_sub':             { en: 'Time-series and dual-axis charts for identifying seasonal patterns and correlations', af: 'Tydreeks- en dubbelas-kaarte vir die identifisering van seisoenale patrone en korrelasies' },
    'r.tr_last30':          { en: 'Last 30 days',       af: 'Laaste 30 dae' },
    'r.tr_last90':          { en: 'Last 90 days',       af: 'Laaste 90 dae' },
    'r.tr_last180':         { en: 'Last 180 days',      af: 'Laaste 180 dae' },
    'r.tr_fullyear':        { en: 'Full year',          af: 'Volle jaar' },
    'r.pest_ts_title':      { en: 'Pest Population Time-Series',                af: 'Plaagpopulasie Tydreeks' },
    'r.disease_rain_title': { en: 'Disease Risk vs. Rainfall (Dual-Axis)',      af: 'Siekterisiko vs. Reënval (Dubbelas)' },
    'r.disease_rain_sub':   { en: 'Bars: wx_rain_mm_hr · Line: alert_disease_high — visualises how rainfall precedes outbreaks', af: 'Stawe: wx_rain_mm_hr · Lyn: alert_disease_high — visualiseer hoe reënval uitbrake voorafgaan' },
    'r.temp_title':         { en: 'Temperature Over Time',                      af: 'Temperatuur Met Verloop Van Tyd' },
    'r.temp_sub':           { en: 'air_temperature_c by site',                  af: 'air_temperature_c per perseel' },
    'r.humid_title':        { en: 'Humidity Over Time',                         af: 'Humiditeit Met Verloop Van Tyd' },
    'r.humid_sub':          { en: 'relative_humidity_pct by site',              af: 'relative_humidity_pct per perseel' },

    /* ── RESEARCHER — CORRELATIONS TAB ── */
    'r.corr_title':         { en: 'Correlations & Patterns',                    af: 'Korrelasies & Patrone' },
    'r.corr_sub':           { en: 'Scatter plots, correlation matrices and thermal window analysis', af: 'Strooikaarte, korrelasie-matrikse en termiese vensteranalise' },
    'r.scatter_title':      { en: 'Pest Activity vs. Temperature',              af: 'Plaagaktiwiteit vs. Temperatuur' },
    'r.scatter_sub':        { en: 'X: air_temperature_c · Y: pest_trap_count — identifies the thermal window', af: 'X: air_temperature_c · Y: pest_trap_count — identifiseer die termiese venster' },
    'r.corrmatrix_title':   { en: 'Environmental Correlation Matrix',           af: 'Omgewingskorrelasie Matriks' },
    'r.corrmatrix_sub':     { en: 'Pearson r between temperature, humidity, leaf wetness & pest count', af: 'Pearson r tussen temperatuur, humiditeit, blaarvog & plaagtelling' },
    'r.computing_corr':     { en: 'Computing correlations...',                  af: 'Korrelasies word bereken...' },
    'r.vib_title':          { en: 'Vibration Level Analysis',                   af: 'Vibrasievlak Analise' },
    'r.vib_sub':            { en: 'vibration_level over time — identify if mechanical vibration correlates with false-positive pest readings', af: 'vibrasievlak oor tyd — identifiseer of meganiese vibrasie met vals-positiewe plaaglesings korreleer' },

    /* ── RESEARCHER — DATA TABLES TAB ── */
    'r.tables_title':       { en: 'Data Tables',        af: 'Data Tabelle' },
    'r.tables_sub':         { en: 'Critical event logs, site risk rankings and sensor health diagnostics', af: 'Kritiese gebeurtenislogboeke, perseel risikoranglys en sensorgsondheiddiagnostiek' },
    'r.crit_log_title':     { en: 'Critical Event Log', af: 'Kritiese Gebeurtenislogboek' },
    'r.crit_log_sub':       { en: "Rows where status = 'critical' — exact conditions leading to system-wide alerts", af: "Rye waar status = 'krities' — presiese toestande wat tot stelselbrede waarskuwings lei" },
    'r.csv':                { en: 'CSV',                af: 'CSV' },
    'r.th_timestamp':       { en: 'Timestamp',          af: 'Tydstempel' },
    'r.th_site':            { en: 'Site',               af: 'Perseel' },
    'r.th_status':          { en: 'Status',             af: 'Status' },
    'r.th_pest_count':      { en: 'Pest Count',         af: 'Plaagtelling' },
    'r.th_temp':            { en: 'Temp °C',            af: 'Temp °C' },
    'r.th_humidity':        { en: 'Humidity %',         af: 'Humiditeit %' },
    'r.th_leaf':            { en: 'Leaf Wetness',       af: 'Blaarvogtigheid' },
    'r.th_rain':            { en: 'Rain mm/hr',         af: 'Reën mm/uur' },
    'r.th_outbreak':        { en: 'Pest Outbreak',      af: 'Plaaguitbraak' },
    'r.th_disease':         { en: 'Disease High',       af: 'Siekte Hoog' },
    'r.risk_rank_title':    { en: 'Site Risk Ranking',  af: 'Perseel Risikoranglys' },
    'r.risk_rank_sub':      { en: 'Ranked by outbreak frequency — site_orchard typically has significantly higher rates', af: 'Gerangskik na uitbraakfrekwensie — site_orchard het tipies aansienlik hoër koerse' },
    'r.th_rank':            { en: 'Rank',               af: 'Rang' },
    'r.th_site_id':         { en: 'Site ID',            af: 'Perseel ID' },
    'r.th_avg_pest':        { en: 'Avg Pest Count',     af: 'Gem. Plaagtelling' },
    'r.th_max_pest':        { en: 'Max Pest Count',     af: 'Maks. Plaagtelling' },
    'r.th_outbreaks':       { en: 'Total Outbreaks',    af: 'Totale Uitbrake' },
    'r.th_disease_days':    { en: 'High Disease Days',  af: 'Hoë Siektedae' },
    'r.th_risk_level':      { en: 'Risk Level',         af: 'Risiko Vlak' },
    'r.th_rel_risk':        { en: 'Relative Risk',      af: 'Relatiewe Risiko' },
    'r.sensor_health_title':{ en: 'Sensor Health Diagnostics',                  af: 'Sensor Gesondheids Diagnostiek' },
    'r.sensor_health_sub':  { en: 'Missing / NaN value counts per field — ensures data integrity before analysis', af: 'Ontbrekende / NaN waarde tellings per veld — verseker data-integriteit voor analise' },
    'r.th_field':           { en: 'Field',              af: 'Veld' },
    'r.th_total_rows':      { en: 'Total Rows',         af: 'Totale Rye' },
    'r.th_missing':         { en: 'Missing Values',     af: 'Ontbrekende Waardes' },
    'r.th_missing_pct':     { en: 'Missing %',          af: 'Ontbrekend %' },
    'r.th_health':          { en: 'Health',             af: 'Gesondheid' },
    'r.running_diag':       { en: 'Running diagnostics...', af: 'Diagnostiek word uitgevoer...' },

    /* ── RESEARCHER — ADVANCED TAB ── */
    'r.adv_title':          { en: 'Advanced Research Features',                 af: 'Gevorderde Navorsings Kenmerke' },
    'r.adv_sub':            { en: 'Diurnal heatmaps, Leaf Wetness Duration and vibration correlation — researcher-only analysis tools', af: 'Diurnale hittepaaie, Blaarvogtigheid Duur en vibrasiekorrelasie — navorsers-slegs analise-instrumente' },
    'r.diurnal_title':      { en: 'Diurnal Activity Heatmap',                   af: 'Diurnale Aktiwiteits Hittekaart' },
    'r.diurnal_sub':        { en: 'Hour of Day × Day of Week · colored by avg pest_trap_count — identifies nocturnal vs diurnal pest behaviour', af: 'Uur van Dag × Dag van Week · gekleur na gem. pest_trap_count — identifiseer nagtelike vs dagtelike plaaggedrag' },
    'r.building_heatmap':   { en: 'Building heatmap...',                        af: 'Hittekaart word gebou...' },
    'r.lwd_title':          { en: 'Leaf Wetness Duration (LWD)',                af: 'Blaarvogtigheid Duur (BVD)' },
    'r.lwd_sub':            { en: 'Consecutive hours leaf_wetness_0_1 ≥ 0.8 — primary driver for crop diseases', af: 'Opeenvolgende ure leaf_wetness_0_1 ≥ 0.8 — primêre drywer vir gewassiektes' },
    'r.calc_lwd':           { en: 'Calculating LWD...',                         af: 'BVD word bereken...' },
    'r.lwd_insight':        { en: 'LWD > 6 consecutive hours is the epidemiological threshold for most fungal infections. Sites exceeding this regularly should be flagged for fungicide application.', af: 'BVD > 6 opeenvolgende ure is die epidemiologiese drempel vir die meeste swaminfeksies. Persele wat dit gereeld oorskry, moet gemerk word vir swamddoder toepassing.' },
    'r.lwd_insight_label':  { en: 'Insight:',           af: 'Insig:' },
    'r.vibscatter_title':   { en: 'Vibration vs. Pest Count',                   af: 'Vibrasie vs. Plaagtelling' },
    'r.vibscatter_sub':     { en: 'Scatter: vibration_level × pest_trap_count — flags potential false-positive readings', af: 'Strooikaart: vibrasievlak × plaagtelling — merk moontlike vals-positiewe lesings' },
    'r.alert_breakdown_title': { en: 'Alert Breakdown by Site',                 af: 'Waarskuwings Uiteensetting per Perseel' },
    'r.alert_breakdown_sub':   { en: 'Pest Action · Pest Outbreak · Disease Moderate · Disease High — distinguishes insect-based vs fungal/pathogenic threats', af: 'Plaagaksie · Plaaguitbraak · Siekte Matig · Siekte Hoog — onderskei insekgebaseerde vs swam/patogeniese bedreigings' },

    /* ── RESEARCHER — NASA TAB ── */
    'r.nasa_title':         { en: 'NASA Data Integration',                      af: 'NASA Data Integrasie' },
    'r.nasa_sub':           { en: 'NASA POWER API — regional contextual data overlaid with ground-truth sensor readings', af: 'NASA POWER API — streekse kontekstuele data oorgelê met grondsensor lesings' },
    'r.nasa_refresh':       { en: 'Refresh NASA',       af: 'NASA Herlaai' },
    'r.nasa_api_title':     { en: 'NASA POWER API — Prediction Of Worldwide Energy Resources', af: 'NASA POWER API — Voorspelling Van Wêreldwye Energiebronne' },
    'r.nasa_api_sub':       { en: 'Regional data for lat/lon of monitored sites · Updated daily', af: 'Streeksdata vir lat/lon van gemonitorde persele · Daagliks opgedateer' },
    'r.nasa_t2m':           { en: 'Regional Temp (T2M)',    af: 'Streeks Temp (T2M)' },
    'r.nasa_t2m_unit':      { en: '°C at 2m height',        af: '°C op 2m hoogte' },
    'r.nasa_solar':         { en: 'Solar Radiation',        af: 'Sonstraling' },
    'r.nasa_solar_unit':    { en: 'W/m² (ALLSKY_SFC_SW_DWN)', af: 'W/m² (ALLSKY_SFC_SW_DWN)' },
    'r.nasa_soil':          { en: 'Surface Soil Moisture',  af: 'Oppervlak Grondvog' },
    'r.nasa_soil_unit':     { en: 'PRECTOTCORR mm/day',     af: 'PRECTOTCORR mm/dag' },
    'r.nasa_gdd':           { en: 'Growing Degree Days',    af: 'Groei Graad Dae' },
    'r.nasa_gdd_unit':      { en: 'GDD (base 10°C)',        af: 'GGD (basis 10°C)' },
    'r.nasa_wind':          { en: 'Wind Speed',             af: 'Windspoed' },
    'r.nasa_wind_unit':     { en: 'm/s at 10m',             af: 'm/s op 10m' },
    'r.nasa_rh':            { en: 'Relative Humidity (RH2M)', af: 'Relatiewe Humiditeit (RH2M)' },
    'r.nasa_rh_unit':       { en: '% at 2m',               af: '% op 2m' },
    'r.nasa_overlay_title': { en: 'Truth vs. Trend — Local Sensor vs. NASA Regional Temperature', af: 'Waarheid vs. Neiging — Plaaslike Sensor vs. NASA Streeks Temperatuur' },
    'r.nasa_overlay_sub':   { en: 'Local air_temperature_c vs NASA T2M — divergence may indicate a microclimate or a failing sensor', af: 'Plaaslike air_temperature_c vs NASA T2M — afwyking kan \'n mikroklimaat of \'n falende sensor aandui' },
    'r.nasa_local':         { en: 'Local sensor',           af: 'Plaaslike sensor' },
    'r.nasa_regional':      { en: 'NASA T2M (regional)',    af: 'NASA T2M (streeks)' },
    'r.nasa_ndvi_title':    { en: 'NDVI Crop Health Index', af: 'NDVI Gewas Gesondheids Indeks' },
    'r.nasa_ndvi_sub':      { en: 'From MODIS satellite — "greenness" proxy for crop health', af: 'Van MODIS satelliet — "groenheid" instaanbegrip vir gewasgesondheid' },
    'r.nasa_ndvi_label':    { en: 'Estimated NDVI (regional avg)', af: 'Beraamde NDVI (streeks gem.)' },
    'r.nasa_ndvi_unit':     { en: '0 = bare soil · 1 = dense vegetation', af: '0 = kaal grond · 1 = digte plantegroei' },
    'r.nasa_ndvi_insight':  { en: 'If NDVI drops while pest_trap_count rises, it confirms pests are actively damaging the crop. NDVI below 0.4 combined with critical status warrants immediate intervention.', af: 'As NDVI daal terwyl pest_trap_count styg, bevestig dit dat plae aktief die gewas beskadig. NDVI onder 0.4 gekombineer met kritiese status regverdig onmiddellike ingryping.' },
    'r.nasa_risk_title':    { en: 'Multi-Source Risk Table',af: 'Multi-Bron Risiko Tabel' },
    'r.nasa_risk_sub':      { en: 'Sensor status × NASA soil moisture × NDVI → combined risk', af: 'Sensor status × NASA grondvog × NDVI → gekombineerde risiko' },
    'r.nasa_loading':       { en: 'Loading...',             af: 'Laai...' },
    'r.nasa_gdd_title':     { en: 'Growing Degree Days (GDD) — Pest Life Cycle Predictor', af: 'Groei Graad Dae (GGD) — Plaag Lewensiklus Voorspeller' },
    'r.nasa_gdd_sub':       { en: 'GDD accumulated from NASA T2M — predicts when pest populations will hit outbreak phase', af: 'GGD geakkumuleer van NASA T2M — voorspel wanneer plaagpopulasies die uitbraakfase sal bereik' },
